    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                $sql = "SELECT * FROM CATEGORY WHERE LEVEL = 1 order by category_type,NAME ";
                ...
                while ($row = $sth->fetch(PDO::FETCH_BOUND)) {
                    echo "<tr>"
                       ...
                       <td>
                       <form name='editParentCategory' action='editParentCategory.php' method='POST'>
                         <input type='hidden' name='category_id' value=$category_id />"
                        . "<input class='btn btn-warning' type='submit' name='editParentCategory' value ='Edit'/> </form></td>"
                        . " <td>
                       <form name='delWarehouse' action='delParentCategory.php' method='POST'>
                         <input type='hidden' name='category_id' value=$category_id />
                      <input class='btn btn-danger' type='submit' name='delParentCategory' value ='Delete'/> </form></td></tr>";
                }
                echo "</table>"
                ?>
